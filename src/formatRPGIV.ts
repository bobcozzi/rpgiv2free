...
// dcl-f RMTDTY disk usage(*input) KEYED prefix(rmt) extfile(rmtduty) usropn rename(dutyrec:rmtdutycdf)
//  dcl-f RMTDTY disk usage(*input) KEYED prefix(rmt) extfile(rmtduty) usropnrename(dutyrec:
//           rmtdutycdf);
